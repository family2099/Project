...
/*http://www.cnblogs.com/Athrun/archive/2012/04/19/pdo_class.html
    PHP PDO SELF 資料庫問題
*    Author: AthrunSoft
...
class pdomysql {
    ...
    public function __construct() {
        ...
        self::connect();
        self::$DB->setAttribute(PDO::MYSQL_ATTR_USE_BUFFERED_QUERY, true);//pdo默認的quey是不使用buffer的，要使用buffer就需要設置mysql_attr_use_buffered_query
